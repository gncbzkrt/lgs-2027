const CACHE='lgs-2027-frozen-v2.1.0-meb-full';
const ASSETS=['./','./index.html','./styles.css','./app.js','./ai.js','./lesson-engine.js','./question-engine.js','./data/curriculum.js','./data/official-curriculum.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
